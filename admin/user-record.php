...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="#" class="brand-link">
      <img src="../images/BEST-LOGO.jpg" alt=" Logo" width="154" height="143" style="opacity: .8;  margin-left: 30PX;">
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><span class="controls"><img src="../apply/images/<?php echo $row['photo'];?>"  width="100" height="100" border="2"/></span></div></td>
