...
<body class="host_version">
	...
	<div id="overviews" class="section wb">
		<h1 style="text-align: center; margin-top: 70px;">OUR PROGRAMMS</h1>
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4 style="font-size: 20px; margin-bottom: 20px;"> <i class="fa fa-check-square"></i> Undergraduation in Arts</h4>

                        <h3><i class="fa fa-angle-right"></i> ADP ( Associate Degree Program )</h3>
                        <h3><i class="fa fa-angle-right"></i> ADA ( Associate Degree in Arts )</h3>
                        <h3><i class="fa fa-angle-right"></i> BA ( Bachelor of Arts )</h3>
                        <p>&nbsp;</p>
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4 style="font-size: 20px; margin-bottom: 20px;"><i class="fa fa-check-square"></i> Undergraduation in Science</h4>

                        <h3><i class="fa fa-angle-right"></i> ADP ( Associate Degree Program )</h3>
                        <h3><i class="fa fa-angle-right"></i> ADS ( Associate Degree in Science )</h3>
                        <h3><i class="fa fa-angle-right"></i> BSC ( Bachelor of Science )
                        	<ul style="margin-top: 7px;">
                        		<li style="list-style: decimal; line-height: 25px;">Double Computer and Phisics</li>
                        		<li style="list-style: decimal;line-height: 25px;">Double Computer and Math</li>
                        		<li style="list-style: decimal; line-height: 25px;">Double Computer and Stat</li>
                        		<li style="list-style: decimal; line-height: 25px;">Double Computer and Econmics</li>
                        	</ul>
                        </h3>
			...
			<div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4 style="font-size: 20px; margin-bottom: 20px"> <i class="fa fa-check-square"></i> Master in Science</h4>
                        <h3><i class="fa fa-angle-right"></i> MCS ( Master in Computer Science)</h3>
                        <h3><i class="fa fa-angle-right"></i> MSC-IT ( Master in Information Technalogy )</h3>
                        <h3><i class="fa fa-angle-right"></i> MSC ( Master in Science )
                        	<ul style="margin-top: 7px;">
                        		<li style="list-style: decimal; line-height: 25px;">Math</li>
                        		<li style="list-style: decimal;line-height: 25px;">Zology</li>
                        		<li style="list-style: decimal; line-height: 25px;">Botony</li>
                        		<li style="list-style: decimal; line-height: 25px;">Chemistry</li>
                        		<li style="list-style: decimal; line-height: 25px;">MBA</li>
                        	</ul>
...
<div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4 style="font-size: 20px; margin-bottom: 20px"><i class="fa fa-check-square"></i> Master in Arts</h4>

                        <h3><i class="fa fa-angle-right"></i> MA - English</h3>
                        <h3><i class="fa fa-angle-right"></i> MA - Special</h3>
                        <h3><i class="fa fa-angle-right"></i> MA - Education</h3>
                        <h3><i class="fa fa-angle-right"></i> MA - Urdu</h3>
                        <h3><i class="fa fa-angle-right"></i> MA - Islamiat</h3>
                        <h3><i class="fa fa-angle-right"></i> MA - Languages</h3>
                         <h3 style="margin-bottom: 10px"><i class="fa fa-angle-right"></i> MA - Social Studies</h3>
