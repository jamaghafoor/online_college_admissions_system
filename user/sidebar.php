...
<li>
  ...
  <!--  <li class="nav nav-second-level"><a href="profile.php">View Profile</a></li> -->
...
<li>
    <a href="#"><i class="fa fa-user"></i> <span class="nav-label">Admission</span><span class="fa arrow"></span></a>
    <ul class="nav nav-second-level collapse">
        <li><a href="/oams2/apply/admission.php">Apply admission</a></li>
    </ul>
</li>
<li>
